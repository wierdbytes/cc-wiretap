  ...
  program
    ...
    .action(async (options: CLIOptions) => {
      ...
      try {
        ...
        console.log(chalk.green('✓'), `WebSocket server started on port ${chalk.cyan(wsPort)}`);
        ...
        console.log(chalk.yellow.bold('Quick setup - run this in any terminal:'));
        console.log();
        console.log(chalk.white.bold(`  ${getSetupCommand()}`));
        console.log();
